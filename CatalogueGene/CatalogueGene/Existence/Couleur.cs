...
namespace CatalogueGene
{
    namespace Existence
    {
        ...
        {
            public static void ColoreGeneSplit(Gene gene, GGene soi)
            {
                int longueur = 0;
            ...
            public static void ColoreGene(Gene gene, GGene soi)
            {
            ...
            public static void DoubleAffichage(Gene gene, GGene soi)
            {
                GGene ggene1 = new GGene(gene);
                ColoreGeneSplit(gene, ggene1);
                GGene ggene2 = new GGene(gene);
                ColoreGene(gene, ggene2);
                soi.Controls.Add(ggene1);
                soi.Controls.Add(ggene2);
                soi.Size = ggene1.Size + ggene2.Size;
            }
